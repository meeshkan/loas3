...
export default (o: $OperationObject, path: string): OperationObject =>
    typeof o !== "object" || Object.keys(o as object).filter(a => OAPI30_OPERATION_ITEM_KEYS.has(a)).length === 0 ?
    { responses: _responses(o) } :
    {
        ...o,
        ...({ responses: _responses((o as OperationObject).responses as $ResponsesObject) }),
        ...((o && (o as OperationObject).parameters) ? { parameters: _parameters((o as any).parameters, path) } : {}),
        ...((o && (o as OperationObject).requestBody) ? { requestBody: _requestBody((o as any).requestBody) } : {}),
    };
