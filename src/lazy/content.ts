...
import { ContentObject } from "../model/OpenApi";
...
export default (o: $ContentObject): ContentObject =>
  (typeof o !== "object" || Object.keys(o as object).filter(a => a.indexOf("/") !== -1).length === 0) ?
  {
    ["application/json"]: mediaType(o),
  } :
  Object.entries(o as ContentObject).map(([a, b]) => ({[a]: mediaType(b)})).reduce((a, b) => ({...a, ...b}), {});
