export default {
  description: "Validation schema for the Lazy OpenAPI Specification 3.0.X.",
  type: "object",
  properties: {
    openapi: {
      type: "string",
  ...
  definitions: {
    ...
    $Schema: {
      anyOf: [
        ...
        {
          $ref: "#/definitions/$SimpleBooleanSchema"
        },
        {
          $ref: "#/definitions/$SimpleIntegerSchema"
        },
        {
          $ref: "#/definitions/$SimpleNumberSchema"
        },
        {
          $ref: "#/definitions/$SimpleStringSchema"
        },
        {
          $ref: "#/definitions/$SimpleArraySchema"
        },
        {
    ...
    $LazyParams: {
      ...
      properties: {
        query: {
          $ref: "#/definitions/$LazyLazyParams"
        },
        header: {
          $ref: "#/definitions/$LazyLazyParams"
        },
