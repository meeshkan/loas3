...
const doYes = (obj: any, l: Array<[string, string | det | _L | Array<string | det | _L>]>): boolean =>
    l.length === 0
        ? true
        : obj[l[0][0]] && (typeof l[0][1] === "string"
        ...
        : false;
// TODO: combine?
const doMaybe = (obj: any, l: Array<[string, string | det | _L | Array<string | det | _L>]>): boolean =>
    l.length === 0
        ? true
        : !obj[l[0][0]] || (typeof l[0][1] === "string"
            ? typeof obj[l[0][0]] === l[0][1]
...
const x = (u: unknown, good: string[]) => Object.keys(u as any).filter(i => good.indexOf(i) === -1 && i.substring(0, 2) !== "x-").length === 0
export const _is = <T>(
...
export const _type = <T>(name: string, validator: Validator<T>) => new t.Type<T>(
    name,
    validator,
